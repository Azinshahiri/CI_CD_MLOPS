...
# installed.
TK_PREFIX='/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/azinshahiri/Desktop/ML_Projects/7-MLOPS/CI_CD_MLOps/env/lib/libtkstub8.6.a'
